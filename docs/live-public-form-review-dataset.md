...
Purpose: manually test the MVP parser against public form surfaces without submitting responses, bypassing access controls, or collecting private data.

Review method:

1. Open each URL manually.
2. Paste the URL into FormMate.
...
Bucket counts below are initial expected summaries. Replace them with observed parser output during review.
