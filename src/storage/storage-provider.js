import { loadProfile, saveProfile, loadSettings, saveSettings, loadVault, saveVault, loadFormHistory, save } from './local-store.js';
...
export async function initRemoteProvider() {
  ...
  try {
    const { SupabaseStorageProvider } = await import('./providers/supabase-storage-provider.js');
