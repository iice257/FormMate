...
export function aiChatScreen() {
  ...
  const chatContent = `
    <div class="flex-1 flex overflow-hidden animate-screen-enter">
      
      <!-- Chat Main Area -->
      <div style="flex: 1; display: flex; flex-direction: column; overflow: hidden;">
        <!-- Chat Header -->
        <div style="display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.5rem; border-bottom: 1px solid var(--fm-border-light); flex-shrink: 0;">
        ...
        <!-- Chat Messages -->
        <div id="chat-messages" style="flex: 1; overflow-y: auto; padding: 2rem; display: flex; flex-direction: column; align-items: center; justify-content: center;" class="no-scrollbar">
        ...
        <!-- Chat Input -->
        <div style="padding: 1rem 1.5rem; border-top: 1px solid var(--fm-border-light); flex-shrink: 0;">
      ...
      <!-- Right Sidebar -->
      <div class="hidden lg:flex" style="width: 280px; border-left: 1px solid var(--fm-border-light); background: #fff; flex-direction: column; padding: 1.25rem; flex-shrink: 0; overflow-y: auto;" class="no-scrollbar">
        <!-- User Card -->
